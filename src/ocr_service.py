...
EXTRACTION_TOOL = {
    ...
    "function": {
        ...
        "description": "Structured fields transcribed from a handwritten Crossing the Ice Keynote demo-call notes photo.",
        "parameters": {
            "type": "object",
            "properties": {
        ...
        messages=[
            {
                ...
                "content": [
                    media_block,
                    {
                        "type": "text",
                        "text": (
                            "Transcribe this handwritten Crossing the Ice Keynote demo-call notes "
                            "page and extract the fields defined in extract_keynote_demo_notes. If "
