"""Dedup/audit tracking against the crossing_the_ice_keynote_proposal_logs
Supabase table (same shared project as the sibling automations,
aivitcomiywiysrfwqxt / "MAGTestProject" — a new, independent table, not
shared with any sibling pipeline).

Actual columns (see db/001_create_crossing_the_ice_keynote_proposal_logs.sql):
